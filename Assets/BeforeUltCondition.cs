...
[CreateAssetMenu(menuName = "Skill System/Skill Conditions/Character Before Ult")]
public class BeforeUltCondition : SkillCondition
{
   ...
   public enum Targetting
    ...
    private void OnBeforeUlt(Character triggeringAlly)
    {
    ...
    public override void Cleanup()
    {
        ...
        {
            if (characters != null)
                characters.BeforeUlt -= OnBeforeUlt;
        }
        Targets.Clear();
    }
